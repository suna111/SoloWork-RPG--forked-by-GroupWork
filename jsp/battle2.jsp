...
<form action="Battle2GoServlet" method="post">
<div id="wrapper">
...
<div class="item">
<img src="/RPG/img/sample.png">
<input type="radio" name="target" value="2" id="target2"><label for="target2">${matangoB.name} / ${matangoB.hp}</label>
</div>
...
<input type="radio" name="action" value="3" id="action3"><label for="action3">飛び蹴り</label>
...
<script src="<%= request.getContextPath() %>/js/battle2.js"></script>
</body>
</html>